...
public class PurchaseseportByProductPdfService : IDocument
{
    private readonly List<RawMaterialPurchaseReportByProducyDto> _data;
    ...
    public PurchaseseportByProductPdfService(List<RawMaterialPurchaseReportByProducyDto> data, ProductSaleTotalDto totalData, string directorName, string username, string role, DateTime? startDate = null, DateTime? endDate = null)
    {
        _data = data;
    ...
    void ComposeHeader(IContainer container)
    {
        container.Row(row =>
        {
            ...
            {
                col.Item().Text("Purchases Report by Product").FontSize(18).Bold().AlignCenter();
    ...
    {
        container.PaddingLeft(40).PaddingTop(15).Column(column =>
        {
            column.Spacing(5);
