...
public class PurchasesReportByEmployeeWordService
{
     public static byte[] Generate(List<SalesReportByEmployeeDto> data, ProductSaleTotalDto totalData, string directorName, string user, string role, DateTime? startDate = null, DateTime? endDate = null)
    {
        ...
        doc.InsertParagraph("Purchases Report by Employee").FontSize(16).Bold().Alignment = Alignment.center;
