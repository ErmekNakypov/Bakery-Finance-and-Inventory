...
public class SalesReportAllWordService
{
    public static byte[] Generate(List<ProductSaleHistoryDto> data, ProductSaleTotalDto totalData, string directorName, string user, string role, DateTime? startDate = null, DateTime? endDate = null)
    {
        ...
        doc.InsertParagraph("Sales Report All").FontSize(16).Bold().Alignment = Alignment.center;
        ...
        table.Rows[0].Cells[2].Paragraphs[0].Append("Sale Date").Bold();;
        ...
        for (int i = 0; i < data.Count; i++)
        {
            ...
            row.Cells[2].Paragraphs[0].Append(item.SaleDate.ToString());
