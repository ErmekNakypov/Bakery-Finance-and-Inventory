...
public static class ManufacturingReportByProductExcelService
{
    public static byte[] Generate(List<ManufacturingReportByProductDto> data, ProductManufacturingTotalDto totalData)
{
