...
public class ManufacturingReportByEmployeePdfService : IDocument
{
    private readonly List<ManufacturingReportByEmployeeDto> _data;
    ...
    public ManufacturingReportByEmployeePdfService(List<ManufacturingReportByEmployeeDto> data, ProductManufacturingTotalDto totalData, string directorName, string username, string role, DateTime? startDate = null, DateTime? endDate = null)
    {
        _data = data;
