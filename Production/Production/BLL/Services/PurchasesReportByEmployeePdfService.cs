...
public class PurchasesReportByEmployeePdfService : IDocument
{
    private readonly List<SalesReportByEmployeeDto> _data;
    ...
    public PurchasesReportByEmployeePdfService(List<SalesReportByEmployeeDto> data, ProductSaleTotalDto totalData, string directorName, string username, string role, DateTime? startDate = null, DateTime? endDate = null)
    {
        _data = data;
    ...
    void ComposeHeader(IContainer container)
    {
        container.Row(row =>
        {
            ...
            {
                col.Item().Text("Purchases Report by Employee").FontSize(18).Bold().AlignCenter();
