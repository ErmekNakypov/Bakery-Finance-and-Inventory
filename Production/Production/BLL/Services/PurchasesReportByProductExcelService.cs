...
public static class PurchasesReportByProductExcelService
{
   public static byte[] Generate(List<RawMaterialPurchaseReportByProducyDto> data, ProductSaleTotalDto totalData)
{
