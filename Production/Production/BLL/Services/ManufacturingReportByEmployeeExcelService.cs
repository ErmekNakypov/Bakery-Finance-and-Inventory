...
public static class ManufacturingReportByEmployeeExcelService
{
    public static byte[] Generate(List<ManufacturingReportByEmployeeDto> data, ProductManufacturingTotalDto totalData)
{
    using var workbook = new XLWorkbook();
    var worksheet = workbook.Worksheets.Add("Manufacturing Report");
    ...
    var dataRange = worksheet.Range(2, 1, data.Count + 1, 3);
    ...
    var totalValues = worksheet.Range(totalRow + 1, 1, totalRow + 1, 3);
