...
public class SalesReportAllProductPdfService : IDocument
{
    private readonly List<ProductSaleHistoryDto> _data;
    ...
    public SalesReportAllProductPdfService(List<ProductSaleHistoryDto> data, ProductSaleTotalDto totalData, string directorName, string username, string role, DateTime? startDate = null, DateTime? endDate = null)
    {
        _data = data;
    ...
    void ComposeHeader(IContainer container)
    {
        container.Row(row =>
        {
            ...
            {
                col.Item().Text("Sales Report All").FontSize(18).Bold().AlignCenter();
        ...
        container.PaddingTop(15).Column(column =>
        {
            ...
            column.Item().Table(table =>
            {
                ...
                table.Header(header =>
                {
                    ...
                    header.Cell().Element(CellStyle).AlignCenter().Text("Sale Date").SemiBold();
                ...
                foreach (var item in _data)
                {
                    ...
                    table.Cell().Element(CellStyle).AlignCenter().Text(item.SaleDate);
