...
public class SalesReportByProductPdfService : IDocument
{
    private readonly List<SalesReportByProductDto> _data;
    ...
    public SalesReportByProductPdfService(List<SalesReportByProductDto> data, ProductSaleTotalDto totalData, string directorName, string username, string role, DateTime? startDate = null, DateTime? endDate = null)
    {
        _data = data;
    ...
    void ComposeHeader(IContainer container)
    {
        container.Row(row =>
        {
            ...
            {
                col.Item().Text("Sales Report by Product").FontSize(18).Bold().AlignCenter();
