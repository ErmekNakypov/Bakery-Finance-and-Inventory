...
public class ManufacturingReportByProductWordService
{
     public static byte[] Generate(List<ManufacturingReportByProductDto> data, ProductManufacturingTotalDto totalData, string directorName, string user, string role, DateTime? startDate = null, DateTime? endDate = null)
    {
        ...
        doc.InsertParagraph("Manufacturing Report by Products").FontSize(16).Bold().Alignment = Alignment.center;
