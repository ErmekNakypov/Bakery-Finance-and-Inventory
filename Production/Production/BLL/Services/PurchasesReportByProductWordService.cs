...
public class PurchasesReportByProductWordService
{
    public static byte[] Generate(List<RawMaterialPurchaseReportByProducyDto> data, ProductSaleTotalDto totalData, string directorName, string user, string role, DateTime? startDate = null, DateTime? endDate = null)
    {
        ...
        doc.InsertParagraph("Purchases by Products").FontSize(16).Bold().Alignment = Alignment.center;
